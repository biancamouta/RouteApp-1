...
class EdgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create edge" do
    assert_difference('Edge.count') do
      post edges_url, params: { edge: { destiny: @edge.destiny, name: @edge.name, source: @edge.source, value: @edge.value } }
    end
  ...
  test "should update edge" do
    patch edge_url(@edge), params: { edge: { destiny: @edge.destiny, name: @edge.name, source: @edge.source, value: @edge.value } }
